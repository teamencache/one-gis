...
function initVertex() {
    ...
    for (let index = 0; index < inputData.points.length; index += webglData.pointLength) {
        ...
        geometry.push.apply(geometry, [
            // x,y,z,r,g,b,a,s1,t1
            xyz[0], xyz[1], xyz[2], 1.0, 0.0, 0.0, 0.6, 0.0, 0.0,
            xyz[0] - inputData.width / 2, xyz[1] - inputData.width / 2, xyz[2] + inputData.height, 0.0, 1.0, 0.0, 0.4, 0.0, 1.0,
            xyz[0] + inputData.width / 2, xyz[1] - inputData.width / 2, xyz[2] + inputData.height, 0.0, 1.0, 0.0, 0.4, 0.25, 1.0,
            xyz[0] + inputData.width / 2, xyz[1] + inputData.width / 2, xyz[2] + inputData.height, 0.0, 1.0, 0.0, 0.4, 0.5, 1.0,
            xyz[0] - inputData.width / 2, xyz[1] + inputData.width / 2, xyz[2] + inputData.height, 0.0, 1.0, 0.0, 0.4, 0.75, 1.0,
        ]);
